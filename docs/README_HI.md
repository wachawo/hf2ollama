...
<workspace>/../llama.cpp/   # एक बार क्लोन, कई वर्कस्पेस में पुनः उपयोग
```

पहला रन [`llama.cpp`](https://github.com/ggerganov/llama.cpp) को आपके
वर्कस्पेस से एक स्तर ऊपर क्लोन कर देता है, ताकि अगले रन तेज़ हों।
सिर्फ़ वही रिपो यह क़दम छोड़ते हैं जो पहले से GGUF रखते हैं।
