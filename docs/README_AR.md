...
<workspace>/../llama.cpp/   # يُستنسخ مرّة، يُعاد استخدامه بين البيئات
```

<div dir="rtl" align="right">

التشغيل الأوّل يستنسخ أيضًا
[`llama.cpp`](https://github.com/ggerganov/llama.cpp) مستوًى فوق بيئة العمل،
لتكون التشغيلات اللاحقة أسرع. فقط المستودعات التي تشحن GGUF جاهزًا تتخطّى
هذه الخطوة.
