...
<workspace>/../llama.cpp/   # একবার ক্লোন, একাধিক ওয়ার্কস্পেসে পুনঃব্যবহার
```

প্রথম রান [`llama.cpp`](https://github.com/ggerganov/llama.cpp)-কে
ওয়ার্কস্পেসের এক স্তর উপরে ক্লোন করে, যাতে পরের রানগুলি দ্রুত হয়।
কেবলমাত্র যেসব রিপোতে আগেই GGUF আছে, সেগুলি এই ধাপ এড়িয়ে যায়।
